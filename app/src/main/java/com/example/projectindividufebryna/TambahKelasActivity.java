...
public class TambahKelasActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    String url = "http://192.168.0.103/inixindo/kelas/tr_add_kelas_mod.php?nama_ins=";
    String url2 = "http://192.168.0.103/inixindo/kelas/tr_add_kelas_mod2.php?nama_mat=";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.tambah_data_kelas_layout);

        spn_id_ins = findViewById(R.id.spinner1);
        spn_id_mat = findViewById(R.id.spinner2);

        edit_mulai_kelas = findViewById(R.id.edit_tgl_mulai_kelas);
    ...
    private void tambahKelas() {
        ...
        class TambahKelas extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... v) {
                ...
                HttpHandler handler = new HttpHandler();
                String result = handler.sendPostRequest(konfigurasi.URL_ADD_KELAS, hashMap);
                Log.d("Uwu", result);
                return result;
            }
            ...
            protected void onPostExecute(String message) {
                super.onPostExecute(message);
                loading.dismiss();
                Intent intent = new Intent(TambahKelasActivity.this, MainActivity.class);
